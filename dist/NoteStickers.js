...
function BoardView() {
    ...
    return html `<${SNS_BoardView}
      ...
      SnapToGrid=${((_a = Application.BoardProperties) === null || _a === void 0 ? void 0 : _a.SnapToGrid) === true}
       GridWidth=${IntegerFor((_b = Application.BoardProperties) === null || _b === void 0 ? void 0 : _b.GridWidth) || 10}
      GridHeight=${IntegerFor((_c = Application.BoardProperties) === null || _c === void 0 ? void 0 : _c.GridHeight) || 10}
    />`;
}
...
PUX.configure({
    ...
    Toolbox: {
        ...
        VisitHomeButton: {
            ...
            onClick: () => { var _a; return doVisitBoard((_a = Application.Project) === null || _a === void 0 ? void 0 : _a.Board(0)); },
        },
        SearchButton: {
            disabled: true,
        },
...
function validateVisitHistory() {
    ...
    visitBoard(VisitHistory[VisitIndex] || ((_a = Application.Project) === null || _a === void 0 ? void 0 : _a.BoardList[0]));
}
//------------------------------------------------------------------------------
//--                                 Console                                  --
//------------------------------------------------------------------------------
...
class SNS_BoardDeserializationOperation extends SNS_Operation {
    ...
    constructor(Folder, sortedSerializations, Index, keepIds = false) {
        super();
        Object.defineProperty(this, "_Folder", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
class SNS_BoardMoveOperation extends SNS_Operation {
    ...
    constructor(oldFolder, sortedBoards, newFolder, Index) {
        super();
        Object.defineProperty(this, "_oldFolder", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "_newFolder", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
class SNS_BoardShiftOperation extends SNS_Operation {
    ...
    constructor(Folder, sortedBoards, sortedIndices) {
        ...
        Object.defineProperty(this, "_forwardMoves", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_backwardMoves", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
...
function BoardsMayBeShiftedOut(BoardList) {
    ...
    return (((_b = (_a = BoardList[0]) === null || _a === void 0 ? void 0 : _a.Folder) === null || _b === void 0 ? void 0 : _b.Folder) != null);
}
...
function PropertiesOfStickers(StickerList) {
    if (StickerList.length === 0) {
        return Object.assign({}, SNS_StickerDefaults);
    }
